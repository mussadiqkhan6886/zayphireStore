    ...
    <div className="w-full">
      ...
      >
        ...
        <SwiperSlide>
          <div className="md:flex-row flex flex-col items-center justify-between bg-amber-50 text-amber-800 overflow-x-hidden">
            <div data-aos="fade-right" className=' h-dvh flex flex-col items-start justify-center m-auto md:pl-18'>
                    <h2 className='font-bold text-7xl'>Zayphire</h2>
                    <div className='flex gap-3 mt-5'>
                    <h2 style={{fontFamily: "Great Vibes"}} className='lg:text-2xl text-2xl tracking-wide'>Where Elegance Begins With Every Thread </h2>
                    
                    </div>
                    <h2 style={{fontFamily: "Great Vibes"}} className='lg:text-2xl text-2xl tracking-wide' > Discover premium  <br /> unstitched  fabrics crafted for timeless beauty.</h2>
                    <div className=' w-[200px] flex p-3 px-7 items-center rounded-3xl mt-5 gap-3'>
