...
const Terms = () => {
  return (
    <main className='pt-15'>
      <h1>Terms</h1>
      <p>📄 Terms & Conditions
Welcome to Zayphire. By placing an order with us or accessing our website, you agree to comply with and be bound by the following terms and conditions. These terms apply to all visitors, users, and customers of Zayphire. We recommend reading them carefully before making any purchase.
...
Once your order is placed, you will receive a confirmation via SMS or email. This confirmation does not signify our acceptance of your order, only that we have received it.
...
6. Returns & Exchanges
Zayphire offers a 7-day exchange policy for size issues only. Refunds or cancellations are not available. To be eligible for an exchange, the product must be returned in its original condition with tags attached. You may return the parcel using any courier service. More details are provided in our Exchange Policy section.
...
For any questions regarding your order, product details, delivery, or policies, you can contact our customer support team via the contact page or by reaching out on WhatsApp or email. We're here to assist you with anything you need.</p>
    </main>
  )
}
